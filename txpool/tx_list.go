...
func (l *txList) Filter(costLimit, gasLimit *big.Int) (Transactions, Transactions) {
	...
	removed := l.txs.Filter(func(tx *Transaction) bool { return tx.Cost().Cmp(costLimit) > 0 || tx.Gas().Cmp(gasLimit) > 0 })
