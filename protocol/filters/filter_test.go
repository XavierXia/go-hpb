...
func BenchmarkFilters(b *testing.B) {
	...
	chain, receipts := core.GenerateChain(params.TestnetChainConfig, genesis, db, 100010, func(i int, gen *core.BlockGen) {
		switch i {
		case 2403:
...
func TestFilters(t *testing.T) {
	...
	chain, receipts := core.GenerateChain(params.TestnetChainConfig, genesis, db, 1000, func(i int, gen *core.BlockGen) {
		switch i {
		case 1:
			receipt := types.NewReceipt(nil, false, new(big.Int))
			receipt.Logs = []*types.Log{
