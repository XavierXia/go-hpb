...
func New(mode SyncMode, stateDb hpbdb.Database, mux *event.TypeMux, chain BlockChain, lightchain LightChain,
...
// these are zero.
func (d *Downloader) Progress() hpbinter.SyncProgress {
