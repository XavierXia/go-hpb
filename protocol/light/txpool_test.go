...
func TestTxPool(t *testing.T) {
	...
	gchain, _ := core.GenerateChain(params.TestnetChainConfig, genesis, sdb, poolTestBlocks, txPoolTestChainGen)
	...
	lightchain, _ := NewLightChain(odr, params.TestnetChainConfig, engine)
	txPermanent = 50
	pool := NewTxPool(params.TestnetChainConfig, lightchain, relay)
