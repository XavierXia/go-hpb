...
func newWorker(config *params.ChainConfig, engine consensus.Engine, coinbase common.Address, hpb Backend, mux *event.TypeMux) *worker {
	worker := &worker{
		config:         config,
		engine:         engine,
		hpb:            hpb,
...
func (self *worker) commitNewWork() {
	...
	pending, err := self.hpb.TxPool().Pending()
	if err != nil {
